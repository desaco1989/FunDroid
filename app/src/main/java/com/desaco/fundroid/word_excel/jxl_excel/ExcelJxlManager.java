package com.desaco.fundroid.word_excel.jxl_excel;
 ...
 *
 */
public class ExcelJxlManager {
    private static ExcelJxlManager instance;
    ...
    private ExcelJxlManager() {

    }

    public static ExcelJxlManager getInstance() {
        if (instance == null) {
            synchronized (ExcelJxlManager.class) {
                if (instance == null) {
                    instance = new ExcelJxlManager();
                }
            }
        }
        return instance;
